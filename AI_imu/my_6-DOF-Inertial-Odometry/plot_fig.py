...
def plot_compare_pos(x, y, gt_pos_data, gt_ori_data1, predict_pos_data, predict_ori_data1):
    ...
    plt.subplot(622); plt.plot(euler_gt_ori_data[:,0]*180/math.pi, label='gt'); plt.grid(True); plt.title(str(x) + " ori x")
    plt.subplot(626); plt.plot(euler_gt_ori_data[:,1]*180/math.pi, label='gt'); plt.grid(True); plt.title(str(x) + " ori y")
    plt.subplot(6,2,10); plt.plot(euler_gt_ori_data[:,2]*180/math.pi, label='gt'); plt.grid(True); plt.title(str(x) + " ori z")

    plt.subplot(624); plt.plot(euler_predict_ori_data[:,0]*180/math.pi, label='predict'); plt.grid(True); plt.title(str(y) + " ori x")
    plt.subplot(628); plt.plot(euler_predict_ori_data[:,1]*180/math.pi, label='predict'); plt.grid(True); plt.title(str(y) + " ori y")
    plt.subplot(6,2,12); plt.plot(euler_predict_ori_data[:,2]*180/math.pi, label='predict'); plt.grid(True); plt.title(str(y) + " ori z")

    plt.subplot(621); plt.plot(gt_pos_data[:,0], label='gt'); plt.grid(True); plt.title(str(x) + " pos x")
    plt.subplot(625); plt.plot(gt_pos_data[:,1], label='gt'); plt.grid(True); plt.title(str(x) + " pos y")
    plt.subplot(6,2,9); plt.plot(gt_pos_data[:,2], label='gt'); plt.grid(True); plt.title(str(x) + " pos z")

    plt.subplot(623); plt.plot(predict_pos_data[:,0], label='predict'); plt.grid(True); plt.title(str(y) + " pos x")
    plt.subplot(627); plt.plot(predict_pos_data[:,1], label='predict'); plt.grid(True); plt.title(str(y) + " pos y")
    plt.subplot(6,2,11); plt.plot(predict_pos_data[:,2], label='predict'); plt.grid(True); plt.title(str(y) + " pos z")
    plt.tight_layout()
...
def plot_pos_error(x, gt_pos_data, gt_ori_data, predict_pos_data, predict_ori_data):
