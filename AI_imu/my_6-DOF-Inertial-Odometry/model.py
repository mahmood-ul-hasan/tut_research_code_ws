...
from tensorflow.keras.layers import Bidirectional, LSTM, LSTM, Dropout, Dense, Input, Layer, Conv1D, MaxPooling1D, concatenate
...
def create_pred_model_6d_quat(window_size):
...
def create_pred_model_6d_quat_absolute(window_size):
    #inp = Input((window_size, 6), name='inp')
    #lstm1 = Bidirectional(LSTM(128, return_sequences=True))(inp)
    x1 = Input((window_size, 3), name='x1')
    x2 = Input((window_size, 3), name='x2')
