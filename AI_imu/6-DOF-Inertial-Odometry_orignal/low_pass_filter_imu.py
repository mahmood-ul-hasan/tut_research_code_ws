...
## ==========================================
# IMU
imu_data_filename = "/mah/AI/6-DOF-Inertial-Odometry_orignal/crane simple motion data/4_15_data_imu_simple_motion_ros_rate_2.csv"
gt_data_filename = "/mah/AI/6-DOF-Inertial-Odometry_orignal/crane simple motion data/4_15_data_gt_simple_motion_ros_rate_2.csv"
...
# fig, (ax1,ax2,ax3, ax4, ax5,ax6) = plt.subplots(nrows=6, sharex=True, subplot_kw=dict(frameon=False)) # frameon=False removes frames
ax1 = plt.subplot(311); plt.plot(time_array, noisy_wx, label='Noisy wx'); plt.grid(True);    plt.legend(); 
ax2 = plt.subplot(312 ); plt.plot(time_array, noisy_wy, label='Noisy wy'); plt.grid(True);    plt.legend(); plt.tick_params('x', labelbottom=False)
ax3 = plt.subplot(313); plt.plot(time_array, noisy_wz, label='Noisy wz'); plt.grid(True);    plt.legend(); plt.tick_params('x', labelbottom=False)
ax1 = plt.subplot(311 ); plt.plot(time_array, filtered_wx, label='Filtered wx'); plt.grid(True);   plt.legend(); plt.ylabel("$w_x$ (rad/s)"); plt.tick_params('x', labelbottom=False)
ax2 = plt.subplot(312); plt.plot(time_array, filtered_wy, label='Filtered wy'); plt.grid(True);   plt.legend(); plt.ylabel("$w_y$ (rad/s)"); plt.tick_params('x', labelbottom=False)
ax3 = plt.subplot(313,); plt.plot(time_array, filtered_wz, label='Filtered wz'); plt.grid(True);   plt.legend(); plt.ylabel("$w_z$ (rad/s)"); plt.xlabel('Time (sec)'); plt.tick_params('x', labelbottom=True)

plt.figure("Accelerometer (Noisy Data vs Filtered Data)", figsize=[7.5,4.5])

ax1 = plt.subplot(311); plt.plot(time_array, noisy_ax, label='Noisy ax'); plt.grid(True);    plt.legend();   plt.tick_params('x', labelbottom=False)
ax2 = plt.subplot(312); plt.plot(time_array, noisy_ay, label='Noisy ay'); plt.grid(True);    plt.legend();  plt.tick_params('x', labelbottom=False)
ax3 = plt.subplot(313); plt.plot(time_array, noisy_az, label='Noisy az'); plt.grid(True);    plt.legend();  plt.tick_params('x', labelbottom=False)
ax1 = plt.subplot(311); plt.plot(time_array, filtered_ax, label='Filtered ax'); plt.grid(True);   plt.legend(); plt.ylabel("$a_x$ $(m/s^2)$");  plt.tick_params('x', labelbottom=False)
ax2 = plt.subplot(312); plt.plot(time_array, filtered_ay, label='Filtered ay'); plt.grid(True);   plt.legend(); plt.ylabel("$a_y$ $(m/s^2)$");  plt.tick_params('x', labelbottom=False)
ax3 = plt.subplot(313); plt.plot(time_array, filtered_az, label='Filtered az'); plt.grid(True);   plt.legend(); plt.ylabel("$a_z$ $(m/s^2$)");plt.xlabel('Time (sec)'); plt.tick_params('x', labelbottom=True)



plt.figure("(Noisy Data vs Filtered Data)", figsize=[7.5,4.5])
matplotlib.rcParams.update({'font.size': 12})
plt.subplot(611); plt.plot(time_array, noisy_wx, label='Noisy wx'); plt.grid(True);    plt.legend(); plt.tick_params('x', labelbottom=False)
plt.subplot(612); plt.plot(time_array, noisy_wy, label='Noisy wy'); plt.grid(True);    plt.legend(); plt.tick_params('x', labelbottom=False)
plt.subplot(613); plt.plot(time_array, noisy_wz, label='Noisy wz'); plt.grid(True);    plt.legend(); plt.tick_params('x', labelbottom=False)
plt.subplot(611); plt.plot(time_array, filtered_wx, label='Filtered wx'); plt.grid(True);   plt.legend(); plt.ylabel("$w_x$ (rad/s)"); plt.tick_params('x', labelbottom=False)
plt.subplot(612); plt.plot(time_array, filtered_wy, label='Filtered wy'); plt.grid(True);   plt.legend(); plt.ylabel("$w_y$ (rad/s)"); plt.tick_params('x', labelbottom=False)
plt.subplot(613); plt.plot(time_array, filtered_wz, label='Filtered wz'); plt.grid(True);   plt.legend(); plt.ylabel("$w_z$ (rad/s)"); plt.tick_params('x', labelbottom=False)

plt.subplot(614); plt.plot(time_array, noisy_ax, label='Noisy ax'); plt.grid(True);    plt.legend(); plt.tick_params('x', labelbottom=False)
plt.subplot(615); plt.plot(time_array, noisy_ay, label='Noisy ay'); plt.grid(True);    plt.legend(); plt.tick_params('x', labelbottom=False)
plt.subplot(616); plt.plot(time_array, noisy_az, label='Noisy az'); plt.grid(True);    plt.legend() ; plt.tick_params('x', labelbottom=False)
plt.subplot(614); plt.plot(time_array, filtered_ax, label='Filtered ax'); plt.grid(True);   plt.legend(); plt.ylabel("$a_x$ $(m/s^2)$"); plt.tick_params('x', labelbottom=False)
plt.subplot(615); plt.plot(time_array, filtered_ay, label='Filtered ay'); plt.grid(True);   plt.legend(); plt.ylabel("$a_y$ $(m/s^2)$"); plt.tick_params('x', labelbottom=False)
plt.subplot(616); plt.plot(time_array, filtered_az, label='Filtered az'); plt.grid(True);   plt.legend(); plt.ylabel("$a_z$ $(m/s^2$)");plt.xlabel('Time (sec)'); plt.tick_params('x', labelbottom=True)
