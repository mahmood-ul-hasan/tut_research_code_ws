...
# model = "/mah/AI/6-DOF-Inertial-Odometry_orignal/model_checkpoint.hdf5"
...
def thread_filter_NN(gt_data, imu_data):
    ...
    if first_loop_flag == False:
        ...
        # init_q[3],
        # init_q[0])
        # init_q_euler = euler_from_quaternion(quat_boom)

        # print("init_q_euler1 = ", np.array(init_q_euler), " ", quat_boom)
        # # publish the rpy
        # init_q1 = quaternion_from_euler(init_q_euler[0]*0, init_q_euler[1] , init_q_euler[2],)
        # init_q1 = [init_q1[3], init_q1[0], init_q1[1],init_q1[2]]
        # quat_boom11 = (
        # init_q1[1],
        # init_q1[2],
        # init_q1[3],
        # init_q1[0])
        # print("init_q_euler2 = ", np.array(euler_from_quaternion(quat_boom11)), " ", quat_boom11)

        # pred_trj_q = quaternion.from_float_array(quat_boom11)
    ...
    # yhat_delta_q[0,3],
    # yhat_delta_q[0,0])
    # yhat_delta_q_euler = euler_from_quaternion(quat_boom)

    # print("yhat_delta_q_euler1 = ", np.array(yhat_delta_q_euler)," ", np.array(quat_boom ))
    # # publish the rpy
    # yhat_delta_q1 = quaternion_from_euler(yhat_delta_q_euler[0]*0, yhat_delta_q_euler[1] , yhat_delta_q_euler[2],)
    # yhat_delta_q = [yhat_delta_q1[3], yhat_delta_q1[0], yhat_delta_q1[1],yhat_delta_q1[2]]
    # quat_boom11 = (
    # yhat_delta_q[1],
    # yhat_delta_q[2],
    # yhat_delta_q[3],
    # yhat_delta_q[0])
    # print("yhat_delta_q_euler2 = ", np.array(euler_from_quaternion(quat_boom11)), " ",np.array(quat_boom11 ))
    ...
    print("cur_p_prd ", np.array(pred_trj_p_time), np.array(pred_trj_q_euler)*180/math.pi , np.array(pred_q))
...
if __name__ == '__main__':
    ...
    if (delta_time > duration) :
        ...
        plot_pos_error_gazebo("pred vs gt error " ,  pred_trj_p[1:nn,1:], pred_trj_p[1:nn,:], gt_slice_array[1:nn,1:4], gt_slice_array[1:nn,4:], n1, n2)
