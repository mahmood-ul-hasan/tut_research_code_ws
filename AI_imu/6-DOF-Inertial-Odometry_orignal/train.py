...
def main():
    ...
    class argument:
        ...
        input = "/media/aisl2/aisl_data/AI_imu/6-DOF-Inertial-Odometry_orignal/MH_02_easy/mav0/imu0/data.csv"
        gt = "/media/aisl2/aisl_data/AI_imu/6-DOF-Inertial-Odometry_orignal/MH_02_easy/mav0/state_groundtruth_estimate0/data.csv"

        # dataset = "my_imu"
        # output = "/mah/AI/6-DOF-Inertial-Odometry_orignal/data_crane_filter_stride_window_50"
    ...
    if args.dataset == 'my_imu':
        ...
        imu_data_filenames.append('/mah/AI/6-DOF-Inertial-Odometry_orignal/data_imu_filter.csv')
        gt_data_filenames.append('/mah/AI/6-DOF-Inertial-Odometry_orignal/data_gt_filter.csv')
