...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        ...
        if (yaw_start_point >= 179 - yaw_start_point_increment):
            yaw_start_point_increment = -yaw_start_point_increment
        elif(yaw_start_point <= -179 - yaw_start_point_increment):
            yaw_start_point_increment = - yaw_start_point_increment
        ...
        if (pitch_start_point <= -90 + 2*pitch_start_point_increment):
