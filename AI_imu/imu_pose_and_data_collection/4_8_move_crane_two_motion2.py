...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        ...
        if (yaw_pos >= 170 and yaw_cycle_start == True):
            rospy.sleep(20)
            yaw_increment = -yaw_increment
        elif(yaw_pos <= -170 and yaw_cycle_start == True):
            rospy.sleep(20)
            yaw_increment = - yaw_increment
            # yaw_cycle_start = False
        
        if (yaw_start_point >= 170 - yaw_start_point_increment):
            yaw_start_point_increment = -yaw_start_point_increment
        elif(yaw_start_point <= -170 - yaw_start_point_increment):
            yaw_start_point_increment = - yaw_start_point_increment
        ...
        if(pitch_pos < -80 and yaw_cycle_start == False):
            pitch_increment = - pitch_increment
            rospy.sleep(20)
        elif(pitch_pos > -30 and yaw_cycle_start == False):
            pitch_increment = - pitch_increment
            rospy.sleep(20)
