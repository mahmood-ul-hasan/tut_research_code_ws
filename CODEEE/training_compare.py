...
class argument:
    dataset = "my_imu" 
    output = "/mah/AI/6-DOF-Inertial-Odometry_orignal/crane simple motion data/4_15_data_model_simple_motion_ros_rate_all_win_200"
...
np.savetxt('/mah/AI/6-DOF-Inertial-Odometry_orignal/crane simple motion data/4_15_data_model_loss_simple_motion_ros_rate_all_win_200', model_loss, delimiter=',', fmt = '%.9f')
